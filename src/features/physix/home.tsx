...
export function PublicHome({preview}:{preview:boolean}) {
 ...
 <section className="px-plan-invite"><div className="px-invite-icon"><Layers size={28}/></div><div><p className="px-eyebrow">Beyond the appointment</p><h2>Your plan.<br/>At your pace.</h2><p>Find your assigned and purchased programmes in your account.</p><Link href={'/app'} className="px-text-link">{'Open your account'}<ArrowRight size={18}/></Link></div></section>
