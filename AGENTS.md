...
One Shell and visual family serve public discovery and private care. Current Home introduces the centre, then uses a horizontal treatment rail, vertically stacked in-clinic/online visit cards, a patient-programme entry and practical first-visit answers. Desktop pairs the visit cards and shows services together. These sections represent different patient tasks, not random card variants. No Services / By area selector. Keep the common Fidelity card family, typography and stable navigation; do not treat old grid-only restrictions as current owner direction. Do not invent an address, directions, actual clinic photo or practitioner portrait to fill an asset gap.
