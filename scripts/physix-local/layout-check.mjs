...
const out=resolve('docs/physix/evidence/persistence-20260919/booking-layout');mkdirSync(out,{recursive:true});const checks=[];
...
try{
 for(const width of [320,390,768,1440]){
  run('set','viewport',String(width),width<700?'844':'1000');go('/app/book');run('wait','.px-service-choice');click('.px-service-choice:first-child');click('.px-book-summary>.button');run('wait','.px-booking-times button');
